...
We can also calculate the variance. Because calculation of the variance only uses the rgrid, we use a for loop seperatly from the one before, but the two for loops follow the same logic.
...
We now can produce some of the figures and tables in the paper. All the figures and tables we produce here only include 2007 results. Comparing to what is in the paper, they may be truncated. 
